-- ArcX Schema v001 — Initial tables and triggers
-- Applied by migrate.js. NEVER edit this file after it has run.
...
-- Immutability trigger: only block changes to financial fields
-- Allow status, tx_hash, block_number, gas_used, response_data, settled_at
-- to be updated (for settlement), but never nonce, from, to, or amount.
