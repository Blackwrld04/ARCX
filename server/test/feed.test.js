...
async function runTests() {
  ...
  // Test 3: Live external fetch for non-curated CVE
  ...
  // Test 4: Sub-millisecond SQLite cache verification
  ...
  // Test 5: Dynamic random threat insight
